...
var jugador1 = new Jugador_1.Jugador("Martin", 20000);
...
var dados = new Dados_1.Dados("Dados");
var ruleta = new Ruleta_1.Ruleta("Ruleta");
...
function iniciarSession() {
    ...
    while (!opcionValida) {
        var opcion = readlineSync.question("¿Desea cargar saldo en su cuenta? 1 para cargar, 0 para continuar: ");
        if (opcion === '0') {
...
function iniciarJuego(casino, juegoIndex, jugador1) {
    ...
    var seguirJugando = true;
    var apuesta = 0, saldoInicial = 0, ganancia = 0;
    while (seguirJugando) {
        switch (juegoSeleccionado.getNombre()) {
            case "Dados":
                ...
                historialDePartidas_1.HistorialDePartidas.registrarPartida(jugador1.getNombreJugador(), juegoSeleccionado.getNombre(), apuesta, ganancia, jugador1.getSaldo());
                break;
            case "Ruleta":
